...
export class DataService {
  ...
  getCustomersByQuery(query: string): Observable<ICustomer[]> {
    ...
    return this.http.get<ICustomer[]>(this.customersBaseUrl, { params })
      .pipe(
        catchError(this.handleError)
      );
  }

  createOrder(id: number, payload: IOrder[]): Observable<IOrder[]> {
    return this.http.post<IOrder[]>(`${this.customersBaseUrl}/${id}/orders`,  payload)
